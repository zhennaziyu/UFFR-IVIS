...
def get_command_line_parser():
    ...
    parser.add_argument('--dataset', type=str, default='Food2K',
                        choices=['Food2K', 'MiniImageNet', 'TieredImageNet', 'CUB', 'FC100', 'CIFAR-FS'])
    # parser.add_argument('--data_root', type=str, default='./data')
    parser.add_argument('--data_root', type=str, default='/home/zhengna/complete/')
    # parser.add_argument('--data_root', type=str, default='/home/zhengna/fgvc-aircraft-2013b/data/images')
    # parser.add_argument('--data_root', type=str, default='/home/zhengna/oxford_pets/images')
    ...
    parser.add_argument('--test_feature', action='store_true', default=False)
    ...
    # parser.add_argument('--init_weights', type=str, default='checkpoints/backbone.pth')
